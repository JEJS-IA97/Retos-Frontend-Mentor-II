...
export const Header = () => {
    ...
    return(
        <header className="bg-Very-Pale-Blue dark:bg-Very-Dark-Blue h-[235px] rounded-b-[20px] pt-8 px-6 mb-[940px] md:mb-[460px] xl:mb-[177px]">
            ...
            <h1 className="text-Very-Dark-Blue dark:text-Very-Pale-Blue xl:text-[30px] text-[25px] font-bold mb-1">Social Media Dashboard</h1>
            <p className="text-Dark-Grayish-Blue xl:text-[14px] text-[16px] dark:text-Desaturated-Blue font-bold mb-6 xl:mb-0">Total Followers: 23,004</p>
            </div>
            <hr className="bg-black mb-[19px] xl:hidden"/>
            <div className="flex justify-between xl:justify-end xl:gap-3">
                <p className="text-Dark-Grayish-Blue dark:text-Desaturated-Blue font-bold xl:text-[14px] text-[16px]">Dark Mode</p>
